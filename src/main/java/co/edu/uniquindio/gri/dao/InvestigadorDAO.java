...
//	}
	...
	/**
	 * Obtiene los investigadores que tiene orcid
	 *
	 * @return lista de investigadores con orcid
	 */
	public List<Investigador> getAllInvestigadoresConOrcid() {
		return investigadorRepository.getInvestigadoresConOrcid();
	}
