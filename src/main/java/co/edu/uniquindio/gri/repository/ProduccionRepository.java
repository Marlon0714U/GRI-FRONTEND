...
public interface ProduccionRepository extends JpaRepository<Produccion, Long> {
	 ...
	 * @return lista de producciones bibliográficas del tipo tipoId.
	 */
	@Query("SELECT NEW co.edu.uniquindio.gri.model.ProduccionBGrupo(pb.id, pb.identificador, pb.autores, pb.anio, pb.referencia, pb.tipo)  from co.edu.uniquindio.gri.model.ProduccionBGrupo pb join pb.grupo g join g.programas p  where p.id =:entityId  and pb.tipo.id =:tipoId")
	List<ProduccionBGrupo> getProduccionBPrograma(@Param("entityId") Long entityId, @Param("tipoId") Long tipoId);
	 ...
	 * @return lista de trabajos dirigidos.
	 */
	@Query("SELECT NEW co.edu.uniquindio.gri.model.ProduccionGrupo(pr.id, pr.autores, pr.anio, pr.referencia, pr.tipo)  from co.edu.uniquindio.gri.model.ProduccionGrupo pr join pr.grupo g join g.programas p where p.id =:entityId and (pr.tipo.id = 1 or pr.tipo.id = 41 or pr.tipo.id = 42 or pr.tipo.id = 43)")
	 ...
	 * @return lista de producciones del tipo tipoId.
	 */
	@Query("SELECT NEW co.edu.uniquindio.gri.model.ProduccionGrupo(pr.id, pr.autores, pr.anio, pr.referencia, pr.tipo)  from co.edu.uniquindio.gri.model.ProduccionGrupo pr join pr.grupo g join g.programas p where p.id =:entityId and pr.tipo.id =:tipoId ")
	...
	List<ProduccionBGrupo> getProduccionBFacultadCentro(@Param("entityId") Long entityId, @Param("tipoId") Long tipoId);
	...
	List<ProduccionGrupo> getProduccionFacultadPrograma(@Param("entityId") Long entityId, @Param("tipoId") Long tipoId);
	...
	List<ProduccionGrupo> getProduccionFacultadCentro(@Param("entityId") Long entityId, @Param("tipoId") Long tipoId);
	...
	/**
	 * Obtiene la producción bibliográfica que coincida con el identificador de la revista.
	 *
	 * @param identificador el tipo de la revista
	 * @return lista de producciones bibliográficas por id de revista
	 */
	@Query("FROM co.edu.uniquindio.gri.model.ProduccionBGrupo where identificador =:identificador")
	List<ProduccionBGrupo> getProduccionBRevista(@Param("identificador") String identificador);
	...
	BigInteger getCantidadProduccionesCentroPorTipo(@Param("centroId") Long centroId, @Param("prodId") Long prodId);
	...
	BigInteger getCantidadProduccionesBCentroPorTipo(@Param("centroId") Long centroId, @Param("prodId") Long prodId);
	...
	BigInteger getCantidadProduccionesCentroPorSubTipo(@Param("centroId") Long centroId, @Param("prodId") Long prodId);
	...
	/**
	 * Obtiene la cantidad de producciones bibliográficas total del programa por un
	 * tipo especifico de producción.
	 * 
	 * @return cantidad de actividades de formacion.
	 * @param programaId el id del programa
	...
	BigInteger getCantidadProduccionesGrupoPorTipo(@Param("grupoId") Long grupoId, @Param("prodId") Long prodId);
	...
	BigInteger getCantidadProduccionesBGrupoPorTipo(@Param("grupoId") Long grupoId, @Param("prodId") Long prodId);
	...
	BigInteger getCantidadProduccionesGrupoPorSubTipo(@Param("grupoId") Long grupoId, @Param("prodId") Long prodId);
	...
	/**
	 * Obtiene la cantidad de producciones que esten asociadas a una Revista
	 * @return numero de producciones asociados a una Revista
	 */
	@Query("SELECT COUNT (p.id) FROM co.edu.uniquindio.gri.model.ProduccionBGrupo p where p.revista is not null")
	int getCantidadProduccionConRevista();
