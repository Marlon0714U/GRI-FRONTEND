...
public interface InvestigadorRepository extends JpaRepository<Investigador, Long> {
	...
	String MODELO_INVESTIGADOR = "co.edu.uniquindio.gri.model.Investigador(i.id, i.nombre, i.categoria, i.nivelAcademico, i.pertenencia,i.sexo, i.orcid)";
	String MODELO_INVESTIGADOR_NATIVE_QUERY = "i.id, i.nombre, i.categoria, i.nivelAcademico, i.pertenencia, i.sexo, i.orcid";
	...
	@Query("select distinct NEW " + MODELO_INVESTIGADOR
			+ " FROM co.edu.uniquindio.gri.model.Investigador i join i.grupos g where g.estado != ''")
	...
	/**
	 * Obtiene los investigadores con orcid
	 *
	 * @return lista de investigadores con orcid
	 */
	@Query("select distinct NEW " + MODELO_INVESTIGADOR
			+ " FROM co.edu.uniquindio.gri.model.Investigador i where i.orcid is not null")
	List<Investigador> getInvestigadoresConOrcid();
