...
public class Investigador implements Serializable {
	...
	public Investigador(long id, String nombre, String categoria, String nivelAcademico, String pertenencia,
			String sexo, Collection<GruposInves> grupos) {
		this.id = id;
		this.nombre = nombre;
		this.categoria = categoria;
		this.nivelAcademico = nivelAcademico;
	...
	public String toString() {
		return "Investigador [id=" + id + ", nombre=" + nombre + ", categoria=" + categoria + ", nivelAcademico="
				+ nivelAcademico + ", pertenencia=" + pertenencia + ", sexo=" + sexo + ", idiomas=" + idiomas
				+ ", lineasInvestigacion=" + lineasInvestigacion + ", producciones=" + producciones
				+ ", produccionesBibliograficas=" + produccionesBibliograficas + ", grupos=" + grupos + "]\n";
	}
